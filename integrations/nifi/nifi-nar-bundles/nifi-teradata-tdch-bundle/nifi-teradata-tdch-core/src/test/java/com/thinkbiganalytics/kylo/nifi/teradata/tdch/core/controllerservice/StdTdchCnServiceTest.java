 ...
 */
public class StdTdchCnServiceTest {

    private static final Logger log = LoggerFactory.getLogger(StdTdchCnServiceTest.class);
    ...
    public void testJdbcDriverClass() throws InitializationException {
        ...
        final TestRunner runner = TestRunners.newTestRunner(TstTdchPrsrForTtngTdchCnSrce.class);
