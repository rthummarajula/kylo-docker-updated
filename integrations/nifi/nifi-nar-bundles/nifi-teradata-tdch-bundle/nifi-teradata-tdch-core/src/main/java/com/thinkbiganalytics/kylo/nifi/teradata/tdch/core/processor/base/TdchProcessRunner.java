...
import com.thinkbiganalytics.kylo.nifi.teradata.tdch.core.processor.export.process.TdchExtHivToTDThdStmHdlr;
...
public class TdchProcessRunner {
    ...
    public TdchProcessResult execute() {
        ...
        try {
            ...
            TdchExtHivToTDThdStmHdlr inputStreamHandler = new TdchExtHivToTDThdStmHdlr(inputStream, logger, logLines, latch, tdchOperationType);
            TdchExtHivToTDThdStmHdlr errorStreamHandler = new TdchExtHivToTDThdStmHdlr(errorStream, logger, logLines, latch, tdchOperationType);
